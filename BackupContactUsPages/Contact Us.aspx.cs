...
public partial class Contact_Us : System.Web.UI.Page
{
    ...
    public static List<DateTime> list = new List<DateTime>();//Declare list as a public, and create a storing list.
    ...
    protected void Calendar1_DayRender(object sender, DayRenderEventArgs e)
    {
        ...
        Session["SelectedDates"] = list;//ends the adding dates to the list created.
